<template>
    <form @submit.prevent="submitUserUpdate" class="card">
        <div class="card-header"
            ...
            <h3 class="card-title">{{user.full_name}} <small class="badge bg-danger-lt" v-if="user.deleted_at">Hesap engelli</small>
            </h3>
            <UserInfoMadals :user="user" no-email></UserInfoMadals>
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" v-model="form_profile.first_name"
                       minlength="1"
                       :class="this.$page.props.errors.first_name?'is-invalid':''" class="form-control"/>
            ...
            <div class="mb-3">
                ...
                <input type="text" v-model="form_profile.last_name"
                       minlength="2"
                       :class="this.$page.props.errors.last_name?'is-invalid':''" class=" form-control"/>
            ...
            <div class="mb-3">
                ...
                <input type="number" v-model="form_profile.tc_kn"
                       :class="this.$page.props.errors.tc_kn?'is-invalid':user.tc_verified_at?'is-valid is-valid-lite':'is-invalid'"
                       class=" form-control form-number"/>
                <div class="invalid-feedback">{{this.$page.props.errors.tc_kn}}</div>
            </div>
            <div class="mb-3">
                <label class="form-label required">Doğum Yılı</label>
                <input type="number" v-model="form_profile.birth_year"
                       :class="this.$page.props.errors.birth_year?'is-invalid':user.tc_verified_at?'is-valid is-valid-lite':'is-invalid'"
                       class=" form-control form-number"/>
                <div class="invalid-feedback">{{this.$page.props.errors.birth_year}}</div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" v-model="form_profile.new_password" :class="this.$page.props.errors.new_password?'is-invalid':''"
                       placeholder="Şifre" class="form-control"/>
                <div class="invalid-feedback">{{this.$page.props.errors.new_password}}</div>
